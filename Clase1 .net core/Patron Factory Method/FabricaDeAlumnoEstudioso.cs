...
{
    class FabricaDeAlumnoEstudioso
    {
        ...
        public  IComparableP CrearAlumnoAlAzar()
        {
            ...
            alumno = new AlumnoMuyEstudioso(Nombre_al_azar(), aleatorio.Next(10000000, 99999999), aleatorio.Next(100, 99999), aleatorio.Next(1, 10));
            return alumno;
        }

        public IComparableP CrearAlumnoPorTeclado()
        {
            alumno = new AlumnoMuyEstudioso(LectorDeDatos.stringPorTeclado(), LectorDeDatos.numeroPorTeclado(), LectorDeDatos.numeroPorTeclado(), LectorDeDatos.numeroPorTeclado());
            return alumno;
        }
    }
}
